Feature: Login de Usuário
  ...
  Scenario: Login realizado com sucesso
    ...
    And existe uma conta ativa cadastrada com o e-mail "carlos@email.com"
    And a senha cadastrada para essa conta é "Senha@123"
    When eu preencho o campo de login "e-mail" com "carlos@email.com"
  ...
  Scenario: Tentar realizar login com senha incorreta
    Given eu estou na tela de login
    And existe uma conta ativa cadastrada com o e-mail "maria@email.com"
    And a senha cadastrada para essa conta é "Maria@123"
    When eu preencho o campo de login "e-mail" com "maria@email.com"
  ...
  @gui @login @e2e
  Scenario: Usuário autenticado acessa suas playlists após login
    Given eu estou na tela de login
    And existe uma conta ativa cadastrada com o e-mail "carlos@email.com"
    And a senha cadastrada para essa conta é "Senha@123"
    When eu preencho o campo de login "e-mail" com "carlos@email.com"
